...
#define MCAST_PORT 7838
#define MCAST_ADDR "230.1.1.88"     /*一个局部连接多播地址，路由器不进行转发*/
...
{  
	...
	//local_addr.sin_addr.s_addr = inet_addr("10.8.0.1");
	//local_addr.sin_addr.s_addr = inet_addr("192.168.0.107");
...
//	}
	...
	mreq.imr_interface.s_addr = inet_addr("192.168.0.107");       /*网络接口为默认*/
	/*将本机加入广播组*/
